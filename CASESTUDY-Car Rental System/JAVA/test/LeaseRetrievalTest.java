...
public class LeaseRetrievalTest {
    ...
    @Test
    public void testLeaseRetrievedSuccessfully() throws SQLException, IOException, ClassNotFoundException, CarNotFoundException, LeaseNotFoundException {
        // Arrange
        ICarLeaseRepository repository = new ICarLeaseRepositoryImpl();
        int leaseId = 1; // Ensure this lease exists in the database

        // Act
        lease retrievedLease = repository.findLeaseById(leaseId);
